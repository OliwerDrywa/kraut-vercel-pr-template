...
function App() {
  return <main className="shell">
    ...
    <div className="card">
      <strong>PR preview pipeline</strong>
      <ol>
        <li>Read <code>PROJECT_PREFERENCES.md</code> for the stack and code style</li>
        <li>Push a feature branch</li>
        <li>Open a pull request</li>
        <li>Vercel deploys an isolated preview</li>
        <li>Review the URL shared by Hermes</li>
      </ol>
    </div>
  </main>
}
